...
class Settings(BaseSettings):
    ...
    IMAGE_JOB_RATE_LIMIT_MAX_ATTEMPTS: int = 8
    IMAGE_JOB_RATE_LIMIT_BASE_DELAY_SECONDS: int = 30
    IMAGE_JOB_RATE_LIMIT_MAX_DELAY_SECONDS: int = 300
    IMAGE_JOB_RATE_LIMIT_JITTER_SECONDS: int = 15
